...
func Load() (*Config, error) {
	...
	return &Config{
		Port:          env("PORT", "8080"),
		Debug:         debug,
		DatabaseURL:   env("DATABASE_URL", "postgres://aifa:aifa@localhost:5432/aifa?sslmode=disable&search_path=notifications,public"),
		...
		APNS: APNSConfig{
			...
			BundleID:   env("APNS_BUNDLE_ID", "app.aifa.ios"),
