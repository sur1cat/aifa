...
// Get retrieves the savings goal for a user (returns nil if not found)
...
// Upsert creates or updates the savings goal for a user
...
// Delete removes the savings goal for a user
...
// GetCurrentSavings calculates the current month's savings (income - expenses)
