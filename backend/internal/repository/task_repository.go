...
// GetByUserID returns all tasks for a user
...
// GetByUserIDAndDate returns tasks for a user on a specific date with pagination
...
// VerifyOwnership checks if a task belongs to a user
