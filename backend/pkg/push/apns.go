...
// APNsClient handles sending push notifications via Apple Push Notification service
...
// generateToken generates a new JWT token for APNs authentication
...
// SendToMany sends notifications to multiple devices
