...
// VerifyIDToken verifies an Apple ID token and returns user info
...
// ParseUserFromInitialSignIn parses user info from the initial Apple Sign In response
// This is only sent on the first sign in
